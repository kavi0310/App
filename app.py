...
def edit(room_id):
    ...
    if room and is_room_admin(room_id, current_user.username):
        ...
        return render_template('edit.html', room=room, room_members_str=room_members_str, message=message)
    else:
...
def view(room_id):
    ...
    if room and is_room_member(room_id, current_user.username):
        ...
        return render_template('view.html', username=current_user.username, room=room, room_members=room_members, messages=messages)
    else:
        return "Room not found", 404
